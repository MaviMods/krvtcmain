...
const DarkMode = ({ children }) => {
    ...
    const lightTailwind = {
        primary: {
            main: "bg-teal-50",
            color: "black",
            border_color: "bg-gray-400 hover:bg-grey-400 active:bg-grey-100 focus:outline-none foucs:ring focus:ring-grey-100 transition duration-500 hover:scale-100",
        },
        secundary: {
            main: "bg-gray-400",
